...
| /clickbait                      | `clickbait.lua`       | -                                                          | Generates a random, click-bait article headline.                                                                                                                                                                                                                                                                                                              | -                |
...
| /counter                        | `counter.lua`         | -                                                          | Adds a view count to the replied-to message.                                                                                                                                                                                                                                                                                                                  | /count           |
...
| /developer                      | `developer.lua`       | -                                                          | Connect with the developer through his social media.                                                                                                                                                                                                                                                                                                          | /dev             |
...
| /doge                           | `doge.lua`            | \<text\>                                                   | Doge-ifies the given text. Sentences are separated using slashes. Example: /doge hello world/this is a test sentence/make sure you type like this/else it won't work!                                                                                                                                                                                         | /dogify          |
| /doggo                          | `doggo.lua`           | -                                                          | Sends a random photo of a dog.                                                                                                                                                                                                                                                                                                                                | /dog             |
| /donate                         | `donate.lua`          | -                                                          | Make an optional, monetary contribution to the mattata project.                                                                                                                                                                                                                                                                                               | -                |
| /duckduckgo                     | `duckduckgo.lua`      | \<query\>                                                  | Searches DuckDuckGo's instant results for the given search query and returns the most relevant result.                                                                                                                                                                                                                                                        | /ddg             |
...
| /exec                           | `exec.lua`            | \<language\> \<code\>                                      | Executes the specified code in the given language and returns the output.                                                                                                                                                                                                                                                                                     | -                |
| /facebook                       | `facebook.lua`        | \<Facebook username\>                                      | Sends the profile picture of the given Facebook user.                                                                                                                                                                                                                                                                                                         | /fb              |
| /fact                           | `fact.lua`            | -                                                          | Returns a random (and somewhat-false!) fact.                                                                                                                                                                                                                                                                                                                  | -                |
...
| /frombin                        | `frombin.lua`         | \<binary\>                                                 | Converts the given string of binary to a numerical value.                                                                                                                                                                                                                                                                                                     | -                |
...
| /github                         | `github.lua`          | \<GitHub username\> \<GitHub repository name\>             | Returns information about the specified GitHub repository.                                                                                                                                                                                                                                                                                                    | /gh              |
| /githubfeed                     | `githubfeed.lua`      | \<sub/del\> \<GitHub username\> \<GitHub repository name\> | Manage your subscriptions to updates from GitHub repositories.                                                                                                                                                                                                                                                                                                | /ghfeed          |
| /google                         | `google.lua`          | \<query\>                                                  | Searches Google for the given search query and returns the most relevant result(s).                                                                                                                                                                                                                                                                           | /g               |
...
| /hextorgb                       | `hextorgb.lua`        | \<hex code\>                                               | Converts the given hex colour code into its RGB format.                                                                                                                                                                                                                                                                                                       | /hrgb            |
| /id                             | `id.lua`              | [chat]                                                     | Sends information about the given chat. Input is also accepted via reply.                                                                                                                                                                                                                                                                                     | /whoami          |
...
| /instagram                      | `instagram.lua`       | \<Instagram username\>                                     | Sends the profile picture of the given Instagram user.                                                                                                                                                                                                                                                                                                        | /ig              |
...
| /jsondump                       | `jsondump.lua`        | -                                                          | Returns the raw JSON of your message.                                                                                                                                                                                                                                                                                                                         | /json            |
...
| /license                        | `license.lua`         | -                                                          | View mattata's license.                                                                                                                                                                                                                                                                                                                                       | -                |
...
| /pokedex                        | `pokedex.lua`         | \<query\>                                                  | Returns a Pokedex entry from pokeapi.co.                                                                                                                                                                                                                                                                                                                      | /dex             |
| /prime                          | `prime.lua`           | \<number\>                                                 | Tells you if a number is prime or not.                                                                                                                                                                                                                                                                                                                        | -                |
...
| /reddit                         | `reddit.lua`          | \<subreddit/query\>                                        | Returns the latest posts from the given subreddit, or for the given query.                                                                                                                                                                                                                                                                                    | /r, /r/subreddit |
...
| /rss                            | `rss.lua`             | \<sub/del\> \<url\>                                        | Manage your RSS feed subscriptions.                                                                                                                                                                                                                                                                                                                           | -                |
| /s/\<pattern\>/\<substitution\> | `sed.lua`             | -                                                          | Replaces all occurences, of text matching a given Lua pattern, with the given substitution.                                                                                                                                                                                                                                                                   | -                |
| /setlang                        | `setlang.lua`         | -                                                          | Allows you to select your language.                                                                                                                                                                                                                                                                                                                           | -                |
| /setloc                         | `setloc.lua`          | \<location\>                                               | Sets your location to the given value.                                                                                                                                                                                                                                                                                                                        | -                |
| /setnews                        | `news.lua`            | \<news source\>                                            | Sets your preferred news source for use with /news.                                                                                                                                                                                                                                                                                                           | -                |
...
| /synonym                        | `synonym.lua`         | \<word\>                                                   | Sends a word similar to the one given.                                                                                                                                                                                                                                                                                                                        | -                |
| /theme                          | `theme.lua`           | -                                                          | Get a theme for Telegram Desktop created by mattata's developer!                                                                                                                                                                                                                                                                                              | -                |
...
| /xkcd                           | `xkcd.lua`            | [query]                                                    | Returns the latest xkcd strip and its alt text. If a number is given, returns that number strip. If 'r' is passed in place of a number, returns a random strip. Any other text passed as the command argument will search Google for a relevant strip and, if applicable, return it.                                                                          | -                |
