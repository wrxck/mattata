...
function time:init(configuration)
 ...
 time.doc = configuration.command_prefix .. [[time <location>
...
function time:action(msg, configuration)
 ...
 local url = 'http://maps.googleapis.com/maps/api/timezone/json?location=' .. coords.lat ..','.. coords.lon .. '&timestamp='..utc
