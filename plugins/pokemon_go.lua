...
function pokemon_go:init(configuration)
	...
	pokemon_go.doc = configuration.command_prefix .. 'pokego <team> - Set your Pokémon Go team for statistical purposes. The team must be valid, and can be referred to by name or color (or the first letter of either). Giving no team name will show statistics.'
