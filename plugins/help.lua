...
function help:onQueryReceive(callback, message)
	...
	if callback.data == 'helpBack' then
		mattata.editMessageText(message.chat.id, message.message_id, '*Hello, ' .. mattata.markdownEscape(message.from.first_name) .. '!*\nMy name is ' .. self.info.first_name .. ' and I\'m an intelligent bot written with precision. There are many things I can do - try clicking the \'Commands\' button below to see what I can do for you.\n\n*Oh, and I work well in groups, too!*\nYou can enable and disable plugins in your group(s) using ' .. configuration.commandPrefix .. 'plugins.\n\n*Confused?*\nDon\'t worry, I was programmed to help! Try using ' .. configuration.commandPrefix .. 'help <command> to get help with a specific plugin and its usage.\n\nI\'m also an innovative example of artificial intelligence - yes, that\'s right; I can learn from you! Try speaking to me right here, or mention me by my name in a group. I can also describe images sent in response to messages I send.', 'Markdown', true, '{"inline_keyboard":[[{"text":"Links", "callback_data":"helpLinks"},{"text":"Statistics", "callback_data":"helpStatistics"},{"text":"Commands", "callback_data":"helpCommands"}]]}')
	end
end
