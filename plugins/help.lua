...
function help:action(msg)
	...
	if input then
		...
		if not res then
			functions.send_message(self, msg.chat.id, 'Please [message me in a private chat](http://telegram.me/mattatabot?start=help) for command-related help.', true, nil, true)
