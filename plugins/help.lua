...
function help:action(msg)
	...
	if input then
		...
		local res = functions.send_message(msg.from.id, help_text, true, nil, true, '{"inline_keyboard":[[{"text":"Official Channel", "url":"https://telegram.me/mattata"},{"text":"Source Code", "url":"https://matthewhesketh.github.io/mattata"},{"text":"Rate me", "url":"https://telegram.me/storebot?start=mattatabot"}]]}')
		if not res then
