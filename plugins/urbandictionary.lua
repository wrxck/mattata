...
function urbandictionary:init(configuration)
 ...
 urbandictionary.triggers = functions.triggers(self.info.username, configuration.command_prefix)
  :t('urbandictionary', true):t('ud', true):t('urban', true).table
 urbandictionary.doc = configuration.command_prefix .. [[urbandictionary <query>
Defines the given word - the Urban Dictionary way.
Aliases: ]] .. configuration.command_prefix .. 'ud, ' .. configuration.command_prefix .. 'urban'
end
