...
function coinflip:onChannelPostReceive(channel_post)
	...
	if input then
		...
		if tonumber(input:gsub('heads', '1'):gsub('h', '1'):gsub('tails', '2'):gsub('t', 2)) == flip then
...
function coinflip:onMessageReceive(message)
