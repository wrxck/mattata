...
function mattata.process_spam(message)
    ...
    if message.chat.type == "private" then
        ...
        print(msg_count .. " - " .. msg_limit .. " - " not mattata.is_global_admin(message.from.id))
        if msg_count == msg_limit and not mattata.is_global_admin(message.from.id) then -- Don't run the antispam plugin if the user is configured as a global admin in `configuration.lua`.
