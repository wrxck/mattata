return { -- when you're translating, do NOT translate the things in CAPS!
    ...
    user_added_bot = 'Sveiki visiem! Paldies, ka pievienoji mani, NAME!',
    left_messages = {
        'RIP NAME.',
    ...
    ai_error = 'Radītāja vārdi atbalsojās: NAME, visam ir savs laiks!',
    specify_blacklisted_user = 'Lūdzu precizējiet lietotāju izmantojot skaitlisko ID.',
    user_now_blacklisted = 'Šis lietotājs vairs nevar mani izmantot.',
    user_now_whitelisted = 'Šis lietotājs mani atkal var brīvi izmantot.',
    message_sent_to_channel = 'Jūsu ziņa ir aizsūtīta!',
    unable_to_send_to_channel = 'Es diemžēl nevarēju aizsūtīt jūsu ziņu.',
    enter_message_to_send_to_channel = 'Lūdzu ievadiet ziņu, ko sūtīt. Formatēšana izmantojot \'markdown\' ir atbalstīta.',
    not_channel_admin = 'Atvainojiet, bet šķiet, ka jūs neesat administrators šajā grupā/kanālā.',
    unable_to_retrieve_channel_admins = 'Es diemžēl nevarēju iegūt sarakstu ar administratoriem šai grupai/kanālam.\n',
    copypasta_length = 'Lūdzu atbildiet ziņai ar mazāk nekā MAXIMUM simboliem.',
    copypasta_must_contain = 'Jūsu izvēlētajai ziņai jāsastāv no burtiem un cipariem!',
    found_one_pwned_account = 'Jūsu izvēlētais lietotājs tika atrasts vienā atmaskojumā!',
    account_found_multiple_leaks = 'Jūsu izvēlētais lietotājs tika atrasts X atmaskojumos(ā)',
