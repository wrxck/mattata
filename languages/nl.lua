return { -- when you're translating, do NOT translate the things in CAPS!
	...
	userAddedBot = 'Hallo, wereld! Bedankt dat je me hebt toegevoegd, NAME!',
	leftChatMessages = {
		'RIP NAME.',
		'Rust in vrede, NAME!',
	...
	aiError = 'Matts woorden echoden: NAME, alles heeft een tijd en plaats, maar niet nu!',
	specifyBlacklistedUser = '	Specificeer de gebruiker met zijn/haar gebruikers-ID.',
	userNowBlacklisted = 'Die gebruiker kan me nu niet meer gebruiken.',
	userNowWhitelisted = 'Die gebruiker kan me nu weer gebruiken.',
	messageSentToChannel = 'Je bericht is verzonden!',
	unableToSendToChannel = 'Sorry, ik kon je bericht niet versturen.',
	enterMessageToSendToChannel = 'Vul een bericht in om te versturen. Markdown-opmaak wordt ondersteund.',
	notChannelAdmin = 'Sorry, je bent geen beheerder van die groep of dat kanaal.',
	unableToRetrieveChannelAdmins = 'Sorry, ik kon geen lijst van beheerders ophalen voor die groep of dat kanaal.\n',
	copypastaLength = 'Antwoord een bericht met maximaal MAXIMUM tekens.',
	copypastaMustContain = 'Het bericht moet alphanumerieke tekens bevatten.',
