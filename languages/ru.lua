...
<<<<<<< HEAD
    ...
    ai_error = 'Мои слова: NAME, для всего есть время и место, но не сейчас!',
    ...
    copypasta_length = 'Пожалуйста ответьте на сообщение с меньшим количеством символов, чем MAXIMUM.',
    copypasta_must_contain = 'В отвеченном сообщении должны быть альфанумерические символы!',
