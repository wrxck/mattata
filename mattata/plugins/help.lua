...
function help:action(msg)
	...
	if input then
		...
		if not res then
			functions.send_message(self, msg, 'Please [message me in a private chat](http://telegram.me/' .. self.info.username .. '?start=help) for command-related help.', true, nil, true)
		elseif msg.chat.type ~= 'private' then
			functions.send_message(self, msg, '*Hi there, mate! I have sent you a private message!*', true, nil, true)
		end
	end
end
return help
