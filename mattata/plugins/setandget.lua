...
function setandget:init(configuration)
    ...
    setandget.doc = configuration.command_prefix .. [[set <name> <value>
Stores a value with the given name. Use "]] .. configuration.command_prefix .. [[set <name> --" to delete the stored value.
]] .. configuration.command_prefix .. [[get [name]
