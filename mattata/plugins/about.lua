...
function about:action(msg, configuration)
	...
	if
		...
		or msg.text_lower:match('^'..config.command_prefix..'about$')
		or msg.text_lower:match('^'..config.command_prefix..'about@'..self.info.username:lower()..'$')
		or msg.text_lower:match('^'..config.command_prefix..'start$')
		or msg.text_lower:match('^'..config.command_prefix..'start@'..self.info.username:lower()..'$')
	then
